<div class="space-y-6">
	...
	<div class="grid gap-6">
		<div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Örnek:</strong> Banka emailinden "Hesabını doğrula" mesajı gelirse, emaildeki
				linke tıklama. Tarayıcı adresi çubuğunda bankanın adresini yazıp gir.
			</div>
		</div>
		...
		<div class="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Kural:</strong> Eğer bir mesaj seni aceleye alıyorsa, 99% dolandırıcıdır.
			</div>
		</div>
		...
		<div class="bg-purple-50 border-l-4 border-purple-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Kural:</strong> Meşru bankalar seni emailde kişisel bilgi girmek için çağırmaz.
			</div>
		</div>
		...
		<div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Güvenli örnek:</strong> Garanti'den email genelde
				<code class="text-xs">info@garantibbva.com.tr</code> gibi resmi adreslerden gelir.
			</div>
		</div>
		...
		<div class="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Kuralı Kırsak Ne Olur?</strong> Para kaybedersin, kişisel bilgilerin çalınabilir veya
				virüs bulaşabilir.
			</div>
		</div>
		...
		<div class="bg-indigo-50 border-l-4 border-indigo-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Zayıf:</strong> 1234, password123<br />
				<strong>Güçlü:</strong> M!s@hg4r5Tnm8kL2
			</div>
		</div>
		...
		<div class="bg-pink-50 border-l-4 border-pink-500 p-6 rounded-r-lg">
			...
			<div class="bg-white p-3 rounded text-sm text-gray-600 border-l-2 border-yellow-400">
				<strong>Örnek:</strong> "Merhaba, Garanti'nin web sitesinden gelen email mi doğru?"
			</div>
		</div>
	</div>
	...
	<div class="bg-gradient-to-r from-green-100 to-blue-100 p-6 rounded-lg mt-8">
		...
		<ul class="space-y-2 text-gray-700">
			<li class="flex gap-3">
				...
				<span>Bağlantılara tıklamadan önce iki kere düşünüyorum</span>
			</li>
			<li class="flex gap-3">
				<input type="checkbox" disabled checked class="w-5 h-5" />
				<span>Gönderici adresini her zaman kontrol ediyorum</span>
			</li>
			<li class="flex gap-3">
				<input type="checkbox" disabled checked class="w-5 h-5" />
				<span>Şifremi hiç kimseyle paylaşmıyorum</span>
			</li>
			<li class="flex gap-3">
				<input type="checkbox" disabled checked class="w-5 h-5" />
				<span>Hediye vaatleri görmezden geliyorum</span>
			</li>
			<li class="flex gap-3">
				<input type="checkbox" disabled checked class="w-5 h-5" />
				<span>Şüphelendiğimde hemen birilerine soruyorum</span>
			</li>
		</ul>
	</div>
</div>
